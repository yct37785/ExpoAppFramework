 ...
 */
const useFirestoreManager = (): FirestoreManagerProps => {
 ...
 */
const FirestoreContext = createContext<FirestoreManagerProps | undefined>(undefined);
 ...
 */
export const useFirestoreContext = (): FirestoreManagerProps => {
